...
var drawGaze = function ( gazePosition, dispParams ) {
	...
	offset_bottom = gazeCanvas.offsetHeight / 2;
	offset_left = gazeCanvas.offsetWidth / 2;
	gazeCanvas.style.bottom = (gazePosition.y - offset_bottom) + "px";
	gazeCanvas.style.left = (gazePosition.x - offset_left) + "px";
